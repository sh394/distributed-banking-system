...
public class Application {
    ...
    private static final String VALID_TRANSACTION_TOPIC ="valid-transaction";
    ...
    public static void main(String[] args) {
        ...
        consumeMessages(VALID_TRANSACTION_TOPIC, kafkaConsumer);
    }
    ...
    private static void approveTransaction(Transaction transaction) {
        System.out.println(String.format("Authorizing transaction for user %s, in the amount of $%.2f, location: %s",
